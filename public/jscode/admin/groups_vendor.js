$(function () {
    ...
    $('body').on('click', '.open_save_product_group_modal', function () {
        ...
        if(modal.length)
        {
            ...
            $.ajax({
                url : base_url2 + '/vendor/products/' + product_id + '/groups/prepareSave',
                type: 'POST',
    ...
    $('body').on('click', '#saveGroupModal .submit_btn', function () {
        ...
        if(modal.length)
        {
            ...
            var url = base_url2 + '/vendor/products/' + product_id + '/groups/save';
            if(typeof id != undefined && id != "")
            {
                url = base_url2 + '/vendor/products/' + product_id + '/groups/save/'+ id;
            }
    ...
    $('body').on('click', '.open_save_group_option_modal', function () {
        ...
        if(modal.length)
        {
            ...
            $.ajax({
                url : base_url2 + '/vendor/products/' + product_id + '/groups/' + product_group_id + '/options/prepareSave',
                type: 'POST',
    ...
    $('body').on('click', '#saveGroupOptionModal .submit_btn', function () {
        ...
        if(modal.length)
        {
            ...
            var url = base_url2 + '/vendor/products/' + product_id + '/groups/' + product_group_id + '/options/save';
            if(typeof id != undefined && id != "")
            {
                url = base_url2 + '/vendor/products/' + product_id + '/groups/' + product_group_id + '/options/save/'+ id;
            }
